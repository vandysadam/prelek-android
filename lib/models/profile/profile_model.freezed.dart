...
abstract class $WalletModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String userid, int balance, String type});
}
...
class _$WalletModelImpl implements _WalletModel {
  const _$WalletModelImpl(
      {this.id = '', this.userid = '', this.balance = 0, this.type = ''});
  ...
  @override
  String toString() {
    return 'WalletModel(id: $id, userid: $userid, balance: $balance, type: $type)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, userid, balance, type);
...
abstract class _WalletModel implements WalletModel {
  const factory _WalletModel(
      ...
      final String userid,
      final int balance,
      final String type}) = _$WalletModelImpl;
...
class _$ProfileModelImpl implements _ProfileModel {
  ...
  @override
  String toString() {
    return 'ProfileModel(name: $name, house_number: $house_number, phone_number: $phone_number, address: $address, wallet: $wallet)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, house_number, phone_number, address, wallet);
...
abstract class _ProfileModel implements ProfileModel {
  const factory _ProfileModel(
      ...
      final String phone_number,
      final String address,
      final WalletModel? wallet}) = _$ProfileModelImpl;
...
abstract class $ApiResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, int statusCode, ProfileModel data});
...
class _$ApiResponseImpl implements _ApiResponse {
  const _$ApiResponseImpl(
      {this.message = '', this.statusCode = 0, required this.data});
  ...
  @override
  String toString() {
    return 'ApiResponse(message: $message, statusCode: $statusCode, data: $data)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, message, statusCode, data);
...
abstract class _ApiResponse implements ApiResponse {
  const factory _ApiResponse(
      {final String message,
      final int statusCode,
      required final ProfileModel data}) = _$ApiResponseImpl;
